...
namespace AspNetCore.ReportingServices.OnDemandReportRendering
{
	...
	public abstract class TextRun : ReportElement, IROMActionOwner
	{
		...
		public virtual List<string> FieldsUsedInValueExpression
		{
			get
			{
				return null;
		...
		public TextRun(Paragraph paragraph, int indexIntoParentCollectionDef, RenderingContext renderingContext)
		...
		public TextRun(Paragraph paragraph, RenderingContext renderingContext)
