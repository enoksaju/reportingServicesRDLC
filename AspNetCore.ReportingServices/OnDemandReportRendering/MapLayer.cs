...
namespace AspNetCore.ReportingServices.OnDemandReportRendering
{
	public abstract class MapLayer : MapObjectCollectionItem
	{
		...
		public AspNetCore.ReportingServices.ReportIntermediateFormat.MapLayer MapLayerDef
		{
			get
			{
		...
		public MapLayerInstance Instance
		{
			get
			{
		...
		public abstract MapLayerInstance GetInstance();
