...
{
	[Serializable]
	public sealed class MapBucket : IPersistable
	{
		...
		public MapBucketExprHost ExprHost
		{
			get
			{
		...
		public void SetExprHost(MapBucketExprHost exprHost, ObjectModelImpl reportObjectModel)
		{
