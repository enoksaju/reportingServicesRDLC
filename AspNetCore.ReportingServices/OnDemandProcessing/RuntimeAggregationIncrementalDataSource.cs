...
{
	public sealed class RuntimeAggregationIncrementalDataSource : RuntimeIncrementalDataSource
	{
		...
		public RuntimeAggregationIncrementalDataSource(DataSet dataSet, OnDemandProcessingContext odpContext)
