...
namespace AspNetCore.Reporting
{
	...
	public class LocalReport
	{
		...
		public Reporting.InternalLocalReport localReport { get; private set; } = new Reporting.InternalLocalReport();
		...
		{
			SubreportProcessing?.Invoke(sender, e);
		}
	...
	public class ReportResult
	{
		...
		/// report body
		/// </summary>
		public ReportStream MainStream { get; set; }
		/// <summary>
		/// such as css style
		/// </summary>
		public ReportStream SecondaryStream { get; set; }
		/// <summary>
	...
	{
		public ReportStream(byte[] bytes)
		{
			if (bytes == null)
			{
				bytes = new byte[0];
